        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="<%request.getContextPath();%>/static/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>해상엔진 테크니션 (선내기/선외기)</span>
                </div>
                <h2 class="sub_top_title">해상엔진 테크니션 (선내기/선외기)</h2>
            </div>
        </div>
        <!-- //sub_top -->
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <input type="text" id="nameKo" name="nameKo" value="${info.name}" placeholder="이름 입력" class="w50" readonly>
                                            <input type="text" id="nameEn" name="nameEn" placeholder="영문" class="w50">
                                        </div>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input form_idNum">
                                            <input type="text" id="rrnFirst" name="rrnFirst" onchange="f_rrn_age_calc(this)" class="onlyNum" maxlength="6" placeholder="앞 6자리">
                                            <span>-</span>
                                            <input type="text" id="rrnLast" name="rrnLast" class="onlyNum" maxlength="7" placeholder="뒤 7자리">
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            만
                                            <input type="text" id="age" name="age" class="onlyNum w50" placeholder="주민번호 앞자리 입력 시 자동 입력됩니다." maxlength="6" readonly>
                                            세
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="naeyong">
                                        ...
                                        <%--<div class="img_replace_cmnt">
                                            ...
                                            <div class="text">
                                                교체할 이미지를 수정(교체) 업로드 하신 후 하단의 [저장] 버튼을 눌러주세요. <br>
                                ...
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="topClothesSize" value="S">S (90)</label>
                                            <label><input type="radio" name="topClothesSize" value="M">M (95)</label>
                                            <label><input type="radio" name="topClothesSize" value="L">L (100)</label>
                                            <label><input type="radio" name="topClothesSize" value="XL">XL (105)</label>
                                            <label><input type="radio" name="topClothesSize" value="XXL">XXL (110)</label>
                                            <label><input type="radio" name="topClothesSize" value="기타">기타</label>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="bottomClothesSize" value="28">28</label>
                                            <label><input type="radio" name="bottomClothesSize" value="30">30</label>
                                            <label><input type="radio" name="bottomClothesSize" value="32">32</label>
                                            <label><input type="radio" name="bottomClothesSize" value="34">34</label>
                                            <label><input type="radio" name="bottomClothesSize" value="36">36</label>
                                            <label><input type="radio" name="bottomClothesSize" value="기타">기타</label>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="shoesSize" value="240">240</label>
                                            <label><input type="radio" name="shoesSize" value="245">245</label>
                                            <label><input type="radio" name="shoesSize" value="250">250</label>
                                            <label><input type="radio" name="shoesSize" value="255">255</label>
                                            <label><input type="radio" name="shoesSize" value="260">260</label>
                                            <label><input type="radio" name="shoesSize" value="265">265</label>
                                            <label><input type="radio" name="shoesSize" value="270">270</label>
                                            <label><input type="radio" name="shoesSize" value="275">275</label>
                                            <label><input type="radio" name="shoesSize" value="280">280</label>
                                            <label><input type="radio" name="shoesSize" value="기타">기타</label>
                                        </div>
                                    </div>
                                </li>
                                <li>
                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <input type="text" id="gradeGbn" name="gradeGbn" placeholder="졸업구분">
                                        </div>
                                ...
                                <li class="w50">
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <input type="text" id="schoolName" name="schoolName" placeholder="학교명">
                                        </div>
                                    </div>
                                </li>
                                <li class="w50">
                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="militaryGbn" value="필">필</label>
                                            <label><input type="radio" name="militaryGbn" value="미필" class="check_etc">미필
                                                <span>(사유 : <input type="text" id="militaryReason" name="militaryReason" class="check_etc_input">)</span>
                                            </label>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="disabledGbn" value="대상">대상</label>
                                            <label><input type="radio" name="disabledGbn" value="비대상">비대상</label>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="jobSupportGbn" value="대상">대상</label>
                                            <label><input type="radio" name="jobSupportGbn" value="비대상">비대상</label>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="techEduGbn" value="있음" class="check_etc">있음 <span>(교육명 : <input type="text" id="techEduName" name="techEduName" class="check_etc_input">)</span></label>
                                            <label><input type="radio" name="techEduGbn" value="없음">없음</label>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <textarea id="applyReason" name="applyReason" placeholder="지원동기"></textarea>
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <textarea id="techReason" name="techReason" placeholder="향후 테크니션 업무 수행시의 인성 적합성 기술"></textarea>
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <textarea id="activityReason" name="activityReason" placeholder="자격 및 경력, 대외 활동 사항"></textarea>
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <textarea id="planReason" name="planReason" placeholder="교육수료 후 포부 (향후 자신의 진로 등)"></textarea>
                                        </div>
                                        <div class="cmnt">
                                ...
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <textarea id="etcReason" name="etcReason" placeholder="기타 사항을 입력해 주세요."></textarea>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="form_btn_box">
                        ...
                        <a href="/apply/eduApply02.do?seq=${seq}" class="btnSt03">초기화</a>
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply02_submit('${seq}');" class="btnSt01">신청하기</a>
                    </div>
