                    ...
                    <div class="guide_sec">
                        ...
                        <ul class="guide_info_2">
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">${i_applyMethod.value} (<span class="underline"><a href="${i_applyMethodUrl.value}" target="_blank">${i_applyMethodUrl.value}</a></span>)</div>
                                </div>
                            </li>
                            <li>
                                <div class="gubun">모집방법</div>
                                <div class="naeyong">
                                    <div class="text">${i_recruitMethod.value}</div>
                            ...
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">${i_recruitPeriod.value}</div>
