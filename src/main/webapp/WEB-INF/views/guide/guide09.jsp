        ...
        <div id="content_wrap">
            ...
            <div id="sidebar">
                ...
                <ul class="lnb">
                    ...
                    <li class="on"><a href="/guide/guide09.do">고마력 선외기 정비 중급 테크니션</a></li>
                ...
                <div class="guide_wrap">
                        ...
                        <div class="guide_top_bnr">
                            <div class="bnr_box w700">
                                ...
                                <div class="text_box">
                                    ...
                                    <div class="small">
                                        고마력 선외기 사용 증가 추세에 따라 향후 고마력 선외기에 대한 지식 및 기술을<br/>
                                        습득한 중급테크니션에 대한 수요도 증가할 것입니다.<br/>
                                        현장에서 필요한 고마력 선외기 시스템 및 전자식 엔진시스템에 대한<br/>
                                        이해를 높이고 고마력 선외기의 분해 및 조립, 고장진단 및 수리가 가능한<br/>
                                        선외기 중급테크니션을 양성하고자 본 교육과정을 개설합니다.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="guide_sec">
                        ...
                        <ul class="guide_info_2">
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">${h_applyMethod.value} (<span class="underline"><a href="${h_applyMethodUrl.value}" target="_blank">${h_applyMethodUrl.value}</a></span>)</div>
                                </div>
                            </li>
                            <li>
                                <div class="gubun">모집방법</div>
                                <div class="naeyong">
                                    <div class="text">${h_recruitMethod.value}</div>
                    ...
                    <div class="guide_inquiry">
                        ...
                        <div class="guide_btn_box">
                            <div class="btn_box">
                                <a href="javascript:void(0);" onclick="window.location.href='/apply/schedule.do?searchText=EDU10'">교육신청 바로가기</a>
                            </div>
                        </div>
                        <!-- //guide_btn_box -->
                    </div>
