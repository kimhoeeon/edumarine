        ...
        <div class="sub_top sub_top_my">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>상시접수</span>
                </div>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <select id="firstApplicationField" name="firstApplicationField">
                                                ...
                                                <option value="세일요트 기초정비실습 과정" <c:if test="${info.firstApplicationField eq '세일요트 기초정비실습 과정'}">selected</c:if> >세일요트 기초정비실습 과정</option>
                                            </select>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <select id="secondApplicationField" name="secondApplicationField">
                                                ...
                                                <option value="세일요트 기초정비실습 과정" <c:if test="${info.secondApplicationField eq '세일요트 기초정비실습 과정'}">selected</c:if> >세일요트 기초정비실습 과정</option>
                                            </select>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <select id="thirdApplicationField" name="thirdApplicationField">
                                                ...
                                                <option value="세일요트 기초정비실습 과정" <c:if test="${info.thirdApplicationField eq '세일요트 기초정비실습 과정'}">selected</c:if> >세일요트 기초정비실습 과정</option>
                                            </select>
                                        </div>
                                    </div>
                                </li>
