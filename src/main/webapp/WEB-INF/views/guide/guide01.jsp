                                    ...
                                    <div class="table">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p>선외기 : 8.24(토) / 9.21(토) / 10.26(토)</p>
                                                    <p>선내기 : 9.7(토) / 10.26(토)</p>
                                                    <p>세일요트 : 8.31(토) / 11.2(토)</p>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p>선외기 : 8.25(일) / 9.22(일) / 10.27(일)</p>
                                                    <p>선내기 : 9.8(일) / 10.27(일)</p>
                                                    <p>세일요트 : 9.1(일) / 11.3(일)</p>
                                                    <p class="small">(주말반) 총 7회</p>
                                                </td>
                                            </tr>
                                            <tr>
