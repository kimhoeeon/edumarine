                    ...
                    <div class="center_sec">
                        ...
                        <div class="center_current_3">
                            <div class="box">
                                ...
                                <ul class="list">
                                    <li>
                                        <div class="img"><img src="/img/img_center_medal_01.png"></div>
                                        <div class="text">
                                            경기규모<br>
                                            세계 11위
                                        </div>
                                    ...
                                    <li>
                                        <div class="img"><img src="/img/img_center_medal_02.png"></div>
                                        <div class="text">
                                            조선업계<br>
                                            세계 1위
                                        </div>
                                    ...
                                    <li>
                                        <div class="img"><img src="/img/img_center_medal_03.png"></div>
                                        <div class="text">
                                            반도체와<br>
                                            TFT-LCD 주역 생산 업체
                                        </div>
                                    ...
                                    <li>
                                        <div class="img"><img src="/img/img_center_medal_04.png"></div>
                                        <div class="text">
                                            세계 4위<br>
                                            자동차 생산국
                                        </div>
                            ...
                            <div class="box">
                                ...
                                <ul class="list">
                                    <li>
                                        <div class="img"><img src="/img/img_center_medal_05.png"></div>
                                        <div class="text">
                                            천이백이십사만 인구<br>
                                            (국내 최대 인구 밀집도)
                                        </div>
                                    ...
                                    <li>
                                        <div class="img"><img src="/img/img_center_medal_06.png"></div>
                                        <div class="text">
                                            243조원 지역 내<br>
                                            총 생산(국내2위)
                                        </div>
                                    ...
                                    <li>
                                        <div class="img"><img src="/img/img_center_medal_07.png"></div>
                                        <div class="text">
                                            수출 실적 875억불<br>
                                            (국내2위)
                                        </div>
                                    ...
                                    <li>
                                        <div class="img"><img src="/img/img_center_medal_08.png"></div>
                                        <div class="text">
                                            54,213개의 공장<br>
                                            (국내1위)
                                        </div>
