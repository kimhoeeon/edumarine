        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>세일요트 기초정비실습 과정</span>
                </div>
                <h2 class="sub_top_title">세일요트 기초정비실습 과정</h2>
            </div>
        </div>
        <!-- //sub_top -->
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                    ...
                    <div class="form_btn_box">
                        ...
                        <input type="hidden" name="chg_trainName" value="세일요트 기초정비실습 과정">
                        ...
                        <div class="popup_inner popup_form">
                            <div class="popup_box popup_form">
                                <div class="box_1">
                                    ...
                                    <div class="text_box">[ 세일요트 기초정비실습 과정 ]을 신청하셨습니다.<br>정말로 취소하시겠습니까?</div>
