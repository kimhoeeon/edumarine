        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="<%request.getContextPath();%>/static/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>자가정비 선내기</span>
                </div>
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                    ...
                    <div class="form_btn_box">
                        ...
                        <input type="hidden" name="chg_trainName" value="해상엔진 자가정비 (선내기)">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply04_modify_submit(this, '${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
                        ...
                        <div class="popup_inner popup_form">
                            <div class="popup_box popup_form">
                                <div class="box_1">
                                    ...
                                    <div class="text_box">[ 해상엔진 자가정비 (선내기) ]을 신청하셨습니다.<br>정말로 취소하시겠습니까?</div>
                                    ...
                                    <div class="btn_box">
                                        ...
                                        <a href="javascript:void(0);" class="btnSt04 btn_next" onclick="f_edu_apply_cancel_btn('${info.seq}','해상엔진 자가정비 (선내기)','payStatus')">확인</a>
                                    </div>
                                </div>
                                <div class="box_2">
                                    <div class="text_box">
