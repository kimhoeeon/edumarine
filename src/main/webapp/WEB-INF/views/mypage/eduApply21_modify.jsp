        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>선외기 팸투어</span>
                </div>
                <h2 class="sub_top_title">선외기 팸투어</h2>
            </div>
        </div>
        <!-- //sub_top -->
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="applyDay" value="6/28(토)" <c:if test="${info.applyDay eq '6/28(토)'}">checked</c:if> >6/28(토)</label>
                                            <label><input type="radio" name="applyDay" value="8/30(토)" <c:if test="${info.applyDay eq '8/30(토)'}">checked</c:if> >8/30(토)</label>
                                            <label><input type="radio" name="applyDay" value="10/18(토)" <c:if test="${info.applyDay eq '10/18(토)'}">checked</c:if> >10/18(토)</label>
                                            <label><input type="radio" name="applyDay" value="11/10(월)" <c:if test="${info.applyDay eq '11/10(월)'}">checked</c:if> >11/10(월)</label>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="form_btn_box">
                        ...
                        <input type="hidden" name="chg_trainName" value="선외기 팸투어">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply21_modify_submit(this, '${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
