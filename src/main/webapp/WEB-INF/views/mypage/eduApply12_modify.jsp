        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    ...
                    <span>교육신청</span>
                    <span>선외기 기초정비교육</span>
                </div>
                <h2 class="sub_top_title">선외기 기초정비교육</h2>
            </div>
        </div>
        <!-- //sub_top -->
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                    ...
                    <div class="form_btn_box">
                        ...
                        <input type="hidden" name="chg_trainName" value="선외기 기초정비교육">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply12_modify_submit(this, '${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
                        ...
                        <div class="popup_inner popup_form">
                            <div class="popup_box popup_form">
                                <div class="box_1">
                                    ...
                                    <div class="text_box">[ 선외기 기초정비교육 ]을 신청하셨습니다.<br>정말로 취소하시겠습니까?</div>
