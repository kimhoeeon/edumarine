...
<c:if test="${status eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/education/template.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">교육 안내 템플릿 관리</span>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li id="edu_marina_recruit_period">
                                                            ...
                                                            <div class="naeyong">
                                                                ...
                                                                <div class="img">
                                                                    <img src="<%request.getContextPath();%>/static/img/img_guide_marina.png" class="pc" style="width: 100%;">
    ...
    <script src="<%request.getContextPath();%>/static/js/jquery.repeater.js"></script>
    <script src="<%request.getContextPath();%>/static/assets/js/custom/formrepeater.bundle.js"></script>
    ...
    <script src="<%request.getContextPath();%>/static/js/mng/template.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
