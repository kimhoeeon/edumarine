        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="<%request.getContextPath();%>/static/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>FRP 선체 정비 테크니션</span>
                </div>
                <h2 class="sub_top_title">FRP 선체 정비 테크니션</h2>
            </div>
        </div>
        <!-- //sub_top -->
                    ...
                    <div class="form_box">
                        ...
                        <ul class="form_list">
                            ...
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="input">
                                        <label><input type="radio" name="f_edu_moreinfo5">홍보</label>
                                        <label><input type="radio" name="f_edu_moreinfo5">추천</label>
                                        <label><input type="radio" name="f_edu_moreinfo5">검색</label>
                                        <label><input type="radio" name="f_edu_moreinfo5" class="check_etc">기타 <span><input type="text" class="check_etc_input"></span></label>
                                    </div>
                                </div>
                            </li>
                        </ul>
