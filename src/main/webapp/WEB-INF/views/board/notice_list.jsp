    ...
    <div id="container">
        ...
        <div class="sub_top sub_top_board">
            <div class="inner">
                ...
                <h2 class="sub_top_title">공지사항</h2>
            </div>
        </div>
        <!-- //sub_top -->
        ...
        <div id="content_wrap">
            ...
            <div id="sidebar">
                ...
                <ul class="lnb">
                    <li class="on"><a href="/board/notice_list.do">공지사항</a></li>
                    ...
                    <div class="board_top">
                        ...
                        <div class="board_search">
                            ...
                            <div class="search_bar">
                                ...
                                <a href="javascript:void(0);" onclick="noticeList(1);" class="search_btn"></a>
                            </div>
                        </div>
                    </div>
                    <!-- //board_top -->
                    ...
                    <div class="board_list_wrap">
                        ...
                        <ul class="list_body">
                            <%--<li class="important">
                                ...
                                <div class="subject"><a href="/board/notice_view.do">제목입력</a></div>
