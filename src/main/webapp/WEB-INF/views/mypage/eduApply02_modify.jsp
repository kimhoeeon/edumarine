                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                ...
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="techEduGbn" value="있음" class="check_etc" <c:if test="${info.techEduGbn eq '있음'}">checked</c:if> >있음
                                                <span>(교육명 :
                                                    <input type="text" id="techEduName" name="techEduName" class="check_etc_input"
                                                           <c:if test="${info.techEduGbn eq '있음'}">value="${info.techEduName}"</c:if>
                                                           <c:if test="${info.techEduGbn eq '없음'}">disabled="disabled"</c:if>
                                                    >)</span>
                                            </label>
                                            <label><input type="radio" name="techEduGbn" value="없음" <c:if test="${info.techEduGbn eq '없음'}">checked</c:if> >없음</label>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <div class="popup_inner popup_form">
                            <div class="popup_box popup_form">
                                <div class="box_1">
                                    ...
                                    <div class="text_box">[ 해상엔진 테크니션 (선내기/선외기) ]을 신청하셨습니다.<br>정말로 취소하시겠습니까?</div>
