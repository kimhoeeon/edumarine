            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                                    ...
                                    <div class="naeyong">
                                        <div style="display: flex; flex-direction: column;">
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="1">고마력 선외기를 장착한 보트를 운항하시는 분
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="2">고마력 선외기를 장착한 보트를 운항할 계획이신 분
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="3">고마력 선외기 엔진에 대하여 관심이 있으신 분
                                            </label>
                                            <label style="margin: 5px 0;">
                    ...
                    <div class="form_btn_box">
                        <a href="/apply/eduApply09.do?seq=${seq}" class="btnSt03">초기화</a>
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply09_submit('${seq}');" class="btnSt01">신청하기</a>
                    </div>
