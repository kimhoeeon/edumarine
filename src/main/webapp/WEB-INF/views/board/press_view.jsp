            ...
            <div id="content" class="sub_board">
                <div class="board_wrap">
                    ...
                    <div class="board_view_wrap">
                        <div class="subject">${pressInfo.title}</div>
                        <div class="info_box">
                            <div class="box write">
                                <div class="gubun">작성자</div>
                                <div class="naeyong">${pressInfo.writer}</div>
                            </div>
                            <div class="box date">
                            ...
                            <div class="box views">
                                ...
                                <div class="naeyong">${pressInfo.viewCnt}</div>
                            </div>
                        </div>
                        <div class="cont_box">
                            ${pressInfo.content}
                        ...
                        <div class="btn_box">
                            <a href="/board/press_list.do" class="btnSt01">목록으로</a>
                        </div>
                    </div>
                    <!-- //board_view -->
