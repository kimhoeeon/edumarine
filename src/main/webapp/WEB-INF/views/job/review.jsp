                ...
                <div class="board_wrap">
                    ...
                    <%--<div class="popup" id="popupJobReview">
                        <div class="popup_inner">
                            <span class="popup_close"><img src="/img/icon_close_white.png" alt="닫기 아이콘"></span>
                            <div class="popup_tit">게시글 제목</div>
                            <div class="popup_box">
                                <div class="img_box"><img src="/img/edumarine_brochure_low_8.jpg"></div>
                                </div>
                            </div>
                        </div>
                    </div>--%>
...
<script src="/js/front/review.js?ver=<%=System.currentTimeMillis()%>"></script>
