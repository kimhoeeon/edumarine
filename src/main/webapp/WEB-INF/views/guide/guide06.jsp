        ...
        <div class="sub_top sub_top_guide">
            <div class="inner">
                <div class="sub_top_nav">
                    ...
                    <span>교육 안내</span>
                    <span>해상엔진 자가정비(선외기)</span>
                </div>
                <h2 class="sub_top_title">해상엔진 자가정비(선외기)</h2>
            </div>
        </div>
        <!-- //sub_top -->
        ...
        <div id="content_wrap">
            ...
            <div id="sidebar">
                ...
                <ul class="lnb">
                    ...
                    <li class="on"><a href="/guide/guide06.do">해상엔진 자가정비(선외기)</a></li>
                ...
                <div class="guide_wrap">
                    ...
                    <div class="guide_top">
                        <div class="guide_top_tit">
                            <div class="big">해상엔진 자가정비(선외기)</div>
                            <div class="eng">Marine Engine Self-Maintenance (Outboard Aircraft)</div>
                            <div class="text">
                                선외기 엔진을 이용한 해양레저활동이 증가하고 있는 상황에서, 해양레저활동 참가자들이 안전하게 해양레저활동을 즐길 수 있도록,<br>
                                선외기 엔진에 대한 자가정비 및 유지보수, 응급조치요령 등의 교육을 실시하오니 관심 있는 분들의 많은 참가 바랍니다.
                            </div>
                        </div>
                        <div class="guide_top_bnr">
                            <div class="bnr_box w700">
                                ...
                                <div class="text_box">
                                    ...
                                    <div class="small">
                                        안전한 해양레저활동을 위하여 해양레저 참가자들의<br>
                                        선외기 자가정비 능력 향상 및 엔진 고장시 응급조치요령 등 습득
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="box_number">
                                                    <div class="number">1) 가솔린엔진 작동원리</div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="box">
                                                    <ul class="list">
                                                        <li>1차: 2023.03.11(토)~03.12(일)</li>
                                                        <li>2차 : 2023.04.22(토)~04.23(일)</li>
                                                        <li>3차 : 2023.05.20(토)~05.21(일)</li>
                                                        <li>4차 : 2023.07.15(토)~07.16(일)</li>
                                                        <li>5차 : 2023.08.19(토)~08.20(일)</li>
                                                        <li>6차 : 2023.09.23(토)~09.24(일)</li>
                                                        <li>7차 : 2023.11.04(토)~11.05(일)</li>
                                                        <li>8차 : 2023.12.09(토)~12.10(일)</li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="box">
                                                    <div class="text">경기 안산시 상록구 해양로 705 사동 P2 212호(경기테크노파크)</div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="guide_sec">
                        ...
                        <ul class="guide_info_2">
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">에듀마린 홈페이지(<span class="underline">www.edumarine.org</span>)에서 해당 과정 신청 접수 및 상시 접수</div>
                                </div>
                            </li>
                            <li>
                    ...
                    <div class="guide_inquiry">
                        ...
                        <div class="guide_btn_box">
                            <div class="btn_box">
                                <a href="javascript:void(0);" onclick="window.location.href='/apply/schedule.do?searchText=EDU06'">교육신청 바로가기</a>
                            </div>
                        </div>
                        <!-- //guide_btn_box -->
                    </div>
