        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="<%request.getContextPath();%>/static/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>자가정비 심화과정 (고마력 선외기)</span>
                </div>
                <h2 class="sub_top_title">자가정비 심화과정 (고마력 선외기)</h2>
            </div>
        </div>
        <!-- //sub_top -->
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                                    ...
                                    <div class="naeyong">
                                        <div style="display: flex; flex-direction: column;">
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="1" <c:if test="${fn:contains(info.trainUnderstand, '1')}">checked</c:if> >고마력 선외기를 장착한 보트를 운항하시는 분
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="2" <c:if test="${fn:contains(info.trainUnderstand, '2')}">checked</c:if> >고마력 선외기를 장착한 보트를 운항할 계획이신 분
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="3" <c:if test="${fn:contains(info.trainUnderstand, '3')}">checked</c:if> >고마력 선외기 엔진에 대하여 관심이 있으신 분
                                            </label>
                                            <label style="margin: 5px 0;">
                    ...
                    <div class="form_btn_box">
                        ...
                        <input type="hidden" name="chg_trainName" value="자가정비 심화과정 (고마력 선외기)">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply09_modify_submit(this, '${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
                        ...
                        <div class="popup_inner popup_form">
                            <div class="popup_box popup_form">
                                <div class="box_1">
                                    ...
                                    <div class="text_box">[ 자가정비 심화과정 (고마력 선외기) ]을 신청하셨습니다.<br>정말로 취소하시겠습니까?</div>
