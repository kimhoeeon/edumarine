                ...
                <div class="guide_wrap">
                        ...
                        <div class="guide_top_bnr">
                            <div class="bnr_box w700">
                                ...
                                <div class="text_box">
                                    ...
                                    <div class="small">
                                        레저선박에 많이 적용되어 있는 선,내외기 드라이브(스턴드라이브)에 대한 이해도를 높이고<br/>
                                        기본정비와 기술정비 및 문제해결에 대한 기술을 전수해 정비인력을 배양하고자 합니다.<br/>
                                        레저시장의 정비신뢰성을 높이고 안전한 해양레저 활동을 즐길 수 있도록 돕는<br/>
                                        교육프로그램에 관심 있는 분들의 많은 참가 바랍니다.
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <td>
                                            <div class="box_number">
                                                <c:forEach var="info" items="${t_contentsList}" begin="0" end="${t_contentsList.size()}" step="1" varStatus="status">
                                                    <c:choose>
                                                        <c:when test="${fn:contains(info.value, '[')}">
                                                            <div style="padding: 10px;">${info.value}</div>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <div style="padding: 5px 25px;">${info.value}</div>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </c:forEach>
                                            </div>
                    ...
                    <div class="guide_sec">
                        ...
                        <ul class="guide_info_2">
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">${t_applyMethod.value} (<span class="underline"><a href="${t_applyMethodUrl.value}" target="_blank">${t_applyMethodUrl.value}</a></span>)</div>
                                </div>
                            </li>
                            <li>
                                <div class="gubun">모집방법</div>
                                <div class="naeyong">
                                    <div class="text">${t_recruitMethod.value}</div>
                            ...
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">${t_recruitPeriod.value}</div>
                    ...
                    <div class="guide_inquiry">
                        ...
                        <div class="guide_btn_box">
                            <div class="btn_box">
                                <a href="javascript:void(0);" onclick="window.location.href='/apply/schedule.do?searchText=EDU11'">교육신청 바로가기</a>
                            </div>
                        </div>
                        <!-- //guide_btn_box -->
                    </div>
