        ...
        <div class="sub_top">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="/img/icon_home_mini.png" alt="홈 아이콘"></span><span>사이트맵</span>
                </div>
            ...
            <div id="content" class="sub_sitemap">
                ...
                <div class="sitemap_box">
                    ...
                    <div class="list">
                        ...
                        <a href="/guide/guide03.do">마리나선박 정비사 실무과정</a>
                        <%--<a href="/guide/guide04.do">FRP 레저보트 선체 정비 테크니션</a>--%>
                        <a href="/guide/guide05.do">위탁교육</a>
                        <%--<a href="/guide/guide12.do">해상엔진 기초정비교육</a>
                        <a href="/guide/guide13.do">해상엔진 응급조치교육</a>--%>
                        <a href="/guide/guide06.do">선외기 기초정비실습 과정</a>
                        <a href="/guide/guide07.do">선내기 기초정비실습 과정</a>
                        <a href="/guide/guide08.do">세일요트 기초정비실습 과정</a>
                        <a href="/guide/guide11.do">자가정비 심화과정 (고마력 선외기)</a>
                        <a href="/guide/guide14.do">발전기 정비 교육</a>
