...
function f_customer_highhorsepower_detail_modal_set(seq){
    /* TM 및 잠재DB 목록 상세 조회 */
    let jsonObj = {
        seq: seq
    };
...
function f_customer_highhorsepower_save(seq){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            /* form valid check */
            let validCheck = f_customer_highhorsepower_valid();

            if(validCheck){

                /* form data setting */
                let data = f_customer_highhorsepower_form_data_setting();
                        ...
                        success: function (data) {
                            if (data.resultCode === "0") {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        f_customer_highhorsepower_modify_init_set(seq); // 재조회
                                    }
                                });
                            } else {
...
function f_customer_highhorsepower_form_data_setting(){
...
function f_customer_highhorsepower_valid(){
