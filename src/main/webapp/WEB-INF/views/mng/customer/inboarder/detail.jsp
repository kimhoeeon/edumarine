                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="row">
                                                        <!--begin::Col-->
                                                        <div class="col-lg-6">
                                                            <input type="text" id="nameKo" name="nameKo" class="form-control form-control-lg form-control-solid-bg me-4" placeholder="이름(국문)" value="${memberInfo.nameKo}" readonly/>
                                                        </div>
                                                        <!--end::Col-->
                                                        <!--begin::Col-->
                                                        <div class="col-lg-6">
