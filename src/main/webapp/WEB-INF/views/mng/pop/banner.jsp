                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-allow-clear="true" data-hide-search="true" onchange="f_pop_banner_search()">
                                                    <option></option>
                                            ...
                                            <div class="ms-auto">
                                                <!--begin::글쓰기-->
                                                <a href="javascript:void(0);" onclick="f_pop_banner_modify_init_set('');" class="btn btn-primary ms-auto">글쓰기</a>
                                                <!--end::글쓰기-->
                                            </div>
                                        </div>
                                        <!--end::Card title-->
