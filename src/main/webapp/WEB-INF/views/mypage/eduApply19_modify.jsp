        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>선외기/선내기 직무역량 강화과정</span>
                </div>
                <h2 class="sub_top_title">선외기/선내기 직무역량 강화과정</h2>
            </div>
        </div>
        <!-- //sub_top -->
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                                    ...
                                    <div class="naeyong">
                                        <div style="display: flex; flex-direction: column;">
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="1" <c:if test="${fn:contains(info.trainUnderstand, '1')}">checked</c:if> >선외기·선내기 정비사 실무과정 수료
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="2" <c:if test="${fn:contains(info.trainUnderstand, '2')}">checked</c:if> >엔진에 대한 지식이 있음
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="3" <c:if test="${fn:contains(info.trainUnderstand, '3')}">checked</c:if> >전기부분에 대한 기초지식이 있음<%--<br/>--%>
                    ...
                    <div class="form_btn_box">
                        ...
                        <input type="hidden" name="chg_trainName" value="선외기/선내기 직무역량 강화과정">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply19_modify_submit(this, '${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
                        ...
                        <div class="popup_inner popup_form">
                            <div class="popup_box popup_form">
                                <div class="box_1">
                                    ...
                                    <div class="text_box">[ 선외기/선내기 직무역량 강화과정 ]을 신청하셨습니다.<br>정말로 취소하시겠습니까?</div>
