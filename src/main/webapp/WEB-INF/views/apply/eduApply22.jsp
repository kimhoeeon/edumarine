            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                <%--<li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="choiceDate" value="9/13(토)">9/13(토)</label>
                                            <label><input type="radio" name="choiceDate" value="10/18(토)">10/18(토)</label>
                    ...
                    <div class="form_btn_box">
                        <a href="/apply/eduApply22.do?seq=${seq}" class="btnSt03">초기화</a>
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply22_submit('${seq}');" class="btnSt01">신청하기</a>
                    </div>
