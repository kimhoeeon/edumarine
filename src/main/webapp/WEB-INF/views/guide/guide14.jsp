        ...
        <div id="content_wrap">
            ...
            <div id="sidebar">
                ...
                <ul class="lnb">
                    ...
                    <li class="on"><a href="/guide/guide14.do">발전기 정비 교육</a></li>
                ...
                <div class="guide_wrap">
                    ...
                    <div class="guide_top">
                        <div class="guide_top_tit">
                            <div class="big">발전기 정비 교육</div>
                            <div class="eng">Maintenance Training for Generator</div>
                            <div class="text">
                                해양 레저선박에 사용하는 발전기에 대한 정비 및 점검 교육을 통하여 해상엔진테크니션의 정비영역을 확장시키고자<br>
                                발전기정비 교육과정을 진행하니 많은 수강 바랍니다.
                            </div>
                        </div>
                        <div class="guide_top_bnr">
                            <div class="bnr_box w700">
                                ...
                                <div class="text_box">
                                    ...
                                    <div class="small">
                                        해상엔진테크니션이 제공할 수 있는 서비스 범위를 발전기 정비 및 점검까지 확장하여 선외기 및 선내기뿐만 아니라 발전기까지 정비할 수 있는 인력을 양성하고자 함.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="guide_inquiry">
                        ...
                        <div class="guide_btn_box">
                            <div class="btn_box">
                                <a href="javascript:void(0);" onclick="window.location.href='/apply/schedule.do?searchText=EDU16'">교육신청 바로가기</a>
                            </div>
                        </div>
                        <!-- //guide_btn_box -->
                    </div>
