        ...
        <div class="sub_top sub_top_guide">
            <div class="inner">
                <div class="sub_top_nav">
                    ...
                    <span>교육 안내</span>
                    <span>해상엔진 자가정비(세일요트)</span>
                </div>
                <h2 class="sub_top_title">해상엔진 자가정비(세일요트)</h2>
            </div>
        </div>
        <!-- //sub_top -->
                ...
                <div class="guide_wrap">
                    ...
                    <div class="guide_top">
                        <div class="guide_top_tit">
                            <div class="big">해상엔진 자가정비(세일요트)</div>
                            <div class="eng">Marine Engine Self-Maintenance (Sale Yacht)</div>
                            <div class="text">
                                선내기 엔진을 장착한 파워보트 등을 이용한 해양레저활동이 증가하고 있는 상황에서,<br>
                                해양레저활동 참가자들이 안전하게 해양레저활동을 즐길 수 있도록, 선내기 엔진에 대한 자가정비 및 유지보수, 응급조치요령 등의 교육을 실시하오니<br>
                                관심 있는 분들의 많은 참가 바랍니다.
                            </div>
                        </div>
                            ...
                            <div class="bnr_box w700">
                                ...
                                <div class="text_box">
                                    ...
                                    <div class="small">
                                        ...
                                        선내기 자가정비 능력 향상 및 엔진 고장시 응급조치요령 등 습득
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <td>
                                                <div class="box">
                                                    <ul class="list">
                                                        ...
                                                        <li>5차 : 2023.10.28(토)~10.29(일)</li>
                                                        <li>6차 : 2023.12.16(토)~12.17(일)</li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="guide_inquiry">
                        ...
                        <div class="guide_btn_box">
                            <div class="btn_box">
                                <a href="javascript:void(0);" onclick="window.location.href='/apply/schedule.do?searchText=EDU08'">교육신청 바로가기</a>
                            </div>
                        </div>
                        <!-- //guide_btn_box -->
                    </div>
