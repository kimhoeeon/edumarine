            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                ...
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="knowPath" value="홍보">홍보</label>
                                            <label><input type="radio" name="knowPath" value="추천">추천</label>
                                            <label><input type="radio" name="knowPath" value="검색">검색</label>
                                            <label><input type="radio" name="knowPath" value="기타" class="check_etc">기타 <span><input type="text" id="knowPathReason" name="knowPathReason" class="check_etc_input"></span></label>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="form_btn_box">
                        <a href="/apply/eduApply03.do?seq=${seq}" class="btnSt03">초기화</a>
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply03_submit('${seq}');" class="btnSt01">신청하기</a>
                    </div>
