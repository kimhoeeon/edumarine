            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                    ...
                    <div class="form_btn_box">
                        ...
                        <input type="hidden" name="chg_trainName" value="고마력 선외기 정비 중급 테크니션 (특별반)">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply10_modify_submit(this, '${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
