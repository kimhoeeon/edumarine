        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="<%request.getContextPath();%>/static/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>스턴드라이브 정비 전문가과정</span>
                </div>
                <h2 class="sub_top_title">스턴드라이브 정비 전문가과정</h2>
            </div>
        </div>
        <!-- //sub_top -->
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                                ...
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div style="display: flex; flex-direction: column;">
                                            ...
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="2" <c:if test="${fn:contains(info.trainUnderstand, '2')}">checked</c:if> >스턴드라이브 정비 분야에 경력이 있으신 분
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="3" <c:if test="${fn:contains(info.trainUnderstand, '3')}">checked</c:if> >경력이 없으나 스턴드라이브 정비 기술 습득을 원하시는 분<br/>
                    ...
                    <div class="form_btn_box">
                        ...
                        <input type="hidden" name="chg_trainName" value="스턴드라이브 정비 전문가과정">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply08_modify_submit(this, '${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
                        ...
                        <div class="popup_inner popup_form">
                            <div class="popup_box popup_form">
                                <div class="box_1">
                                    ...
                                    <div class="text_box">[ 스턴드라이브 정비 전문가과정 ]을 신청하셨습니다.<br>정말로 취소하시겠습니까?</div>
