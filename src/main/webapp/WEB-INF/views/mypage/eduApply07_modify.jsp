        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="<%request.getContextPath();%>/static/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>고마력 선외기 정비 중급 테크니션</span>
                </div>
                <h2 class="sub_top_title">고마력 선외기 정비 중급 테크니션</h2>
            </div>
        </div>
        <!-- //sub_top -->
                ...
                <div class="join_wrap form_wrap">
                    ...
                    <form id="joinForm" method="post" onsubmit="return false;">
                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                <li>
                                    <div class="gubun req"><p>작업복 사이즈<span>(남여공용)</span></p></div>
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="clothesSize" value="S" <c:if test="${info.clothesSize eq 'S'}">checked</c:if> >S (90)</label>
                                            <label><input type="radio" name="clothesSize" value="M" <c:if test="${info.clothesSize eq 'M'}">checked</c:if> >M (95)</label>
                                            <label><input type="radio" name="clothesSize" value="L" <c:if test="${info.clothesSize eq 'L'}">checked</c:if> >L (100)</label>
                                            <label><input type="radio" name="clothesSize" value="XL" <c:if test="${info.clothesSize eq 'XL'}">checked</c:if> >XL (105)</label>
                                            <label><input type="radio" name="clothesSize" value="XXL" <c:if test="${info.clothesSize eq 'XXL'}">checked</c:if> >XXL (110)</label>
                                            <label><input type="radio" name="clothesSize" value="기타" <c:if test="${info.clothesSize eq '기타'}">checked</c:if> >기타</label>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    <div class="gubun req"><p>교육 이해</p></div>
                                    <div class="naeyong">
                                        <div style="display: flex; flex-direction: column;">
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="1" <c:if test="${fn:contains(info.trainUnderstand, '1')}">checked</c:if> >해상엔진테크니션양성과정 및 마리나선박선외기/선내기정비사 실무과정 수료생
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="2" <c:if test="${fn:contains(info.trainUnderstand, '2')}">checked</c:if> >선외기 정비 분야에 경력이 있으신 분
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="3" <c:if test="${fn:contains(info.trainUnderstand, '3')}">checked</c:if> >경력이 없으나 선외기 정비 기술 습득을 원하시는 분<br/>
                                                <span style="margin-left: 30px;">
                                                    ( 단, 본 과정은 중급과정으로서 기존 초급과정에 대한 기본적인 지식 및 실습 경험이 필요하다는 것을 고려하여 지원 바랍니다. )
                                                </span>
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="4" class="checkbox_etc" <c:if test="${fn:contains(info.trainUnderstand, '4')}">checked</c:if> >기타 <input type="text" id="trainUnderstandEtc" name="trainUnderstandEtc" value="${info.trainUnderstandEtc}" placeholder="직접 입력" style="margin-left: 5px; width: 85%;" disabled>
                                            </label>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="form_btn_box">
                        ...
                        <input type="hidden" name="chg_trainName" value="고마력 선외기 정비 중급 테크니션">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply07_modify_submit(this, '${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
                        ...
                        <div class="popup_inner popup_form">
                            <div class="popup_box popup_form">
                                <div class="box_1">
                                    ...
                                    <div class="text_box">[ 고마력 선외기 정비 중급 테크니션 ]을 신청하셨습니다.<br>정말로 취소하시겠습니까?</div>
...
<script>
    $(function(){
        ...
        if(trainUnderstand === '4'){
            $('#trainUnderstandEtc').prop('disabled',false);
        }
