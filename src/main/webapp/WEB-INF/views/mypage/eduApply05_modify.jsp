            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                    ...
                    <div class="form_btn_box">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply05_modify_submit('${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
                            ...
                            <div class="popup_box popup_form">
                                <div class="box_1">
                                    ...
                                    <div class="btn_box">
                                        ...
                                        <a href="javascript:void(0);" class="btnSt04 btn_next" onclick="f_edu_apply_cancel_btn('${info.seq}','해상엔진 자가정비 (선외기)')">확인</a>
                                    </div>
                                </div>
                                <div class="box_2">
                                    <div class="text_box">
