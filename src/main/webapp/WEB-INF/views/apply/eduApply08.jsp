            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                                ...
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div style="display: flex; flex-direction: column;">
                                            ...
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="2">스턴드라이브 정비 분야에 경력이 있으신 분
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="3">경력이 없으나 스턴드라이브 정비 기술 습득을 원하시는 분<br/>
                    ...
                    <div class="form_btn_box">
                        <a href="/apply/eduApply08.do?seq=${seq}" class="btnSt03">초기화</a>
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply08_submit('${seq}');" class="btnSt01">신청하기</a>
                    </div>
