            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                                        ...
                                        <div class="naeyong">
                                            <ul>
                                                <li class="bodyPhotoFile_li" style="display: flex; align-items: center;">
                                                    ...
                                                    <a href="/file/download.do?path=member/frp/${bodyPhotoFile.folderPath}&fileName=${bodyPhotoFile.fullFileName}">
                                                        <c:choose>
                                        ...
                                        <div class="naeyong">
                                            <ul>
                                                <li class="gradeLicenseFile_li" style="display: flex; align-items: center;">
                                                    ...
                                                    <a href="/file/download.do?path=member/frp/${gradeLicenseFile.folderPath}&fileName=${gradeLicenseFile.fullFileName}">
                                                        <c:choose>
                    ...
                    <div class="form_btn_box">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply03_modify_submit(this, '${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
