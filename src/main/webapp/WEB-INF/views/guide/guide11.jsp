        ...
        <div id="content_wrap">
            ...
            <div id="sidebar">
                ...
                <ul class="lnb">
                    ...
                    <li class="on"><a href="/guide/guide11.do">자가정비 심화과정 (고마력 선외기)</a></li>
                ...
                <div class="guide_wrap">
                    ...
                    <div class="guide_top">
                        <div class="guide_top_tit">
                            <div class="big">자가정비 심화과정 (고마력 선외기)</div>
                            <div class="eng">In-depth self-maintenance curriculum (high horsepower outboard)</div>
                            <div class="text">
                                고마력 선외기에 대한 유지관리능력 및 응급상황 발생 시 대처 등을 원활하게 수행할 수 있는<br/>
                                고마력 선외기 자가정비 심화 교육과정을 개설하오니 많은 지원 바랍니다.
                            </div>
                        </div>
                        <div class="guide_top_bnr">
                            <div class="bnr_box w700">
                                ...
                                <div class="text_box">
                                    ...
                                    <div class="small">
                                        고마력 선외기를 이용한 안전한 해양레저활동을 즐길 수 있도록<br/>
                                        해양레저 참가자들의 고마력 선외기에 대한 자가정비 및 응급조치요령 습득
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="guide_sec">
                        ...
                        <ul class="guide_info_2">
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">${e_applyMethod.value} (<span class="underline"><a href="${e_applyMethodUrl.value}" target="_blank">${e_applyMethodUrl.value}</a></span>)</div>
                                </div>
                            </li>
                            <li>
                                <div class="gubun">모집방법</div>
                                <div class="naeyong">
                                    <div class="text">${e_recruitMethod.value}</div>
                            ...
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">${e_recruitPeriod.value}</div>
                    ...
                    <div class="guide_inquiry">
                        ...
                        <div class="guide_btn_box">
                            <div class="btn_box">
                                <a href="javascript:void(0);" onclick="window.location.href='/apply/schedule.do?searchText=EDU12'">교육신청 바로가기</a>
                            </div>
                        </div>
                        <!-- //guide_btn_box -->
                    </div>
