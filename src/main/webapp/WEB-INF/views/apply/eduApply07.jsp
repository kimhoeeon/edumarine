            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="clothesSize" value="S">S (90)</label>
                                            <label><input type="radio" name="clothesSize" value="M">M (95)</label>
                                            <label><input type="radio" name="clothesSize" value="L">L (100)</label>
                                            <label><input type="radio" name="clothesSize" value="XL">XL (105)</label>
                                            <label><input type="radio" name="clothesSize" value="XXL">XXL (110)</label>
                                            <label><input type="radio" name="clothesSize" value="기타">기타</label>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div style="display: flex; flex-direction: column;">
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="1">해상엔진테크니션양성과정 및 마리나선박선외기/선내기정비사 실무과정 수료생
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="2">선외기 정비 분야에 경력이 있으신 분
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="3">경력이 없으나 선외기 정비 기술 습득을 원하시는 분<br/>
                                                <span style="margin-left: 30px;">
                                                    ( 단, 본 과정은 중급과정으로서 기존 초급과정에 대한 기본적인 지식 및 실습 경험이 필요하다는 것을 고려하여 지원 바랍니다. )
                                                </span>
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="4" class="checkbox_etc">기타 <input type="text" id="trainUnderstandEtc" name="trainUnderstandEtc" placeholder="직접 입력" style="margin-left: 5px; width: 85%;" disabled>
                                            </label>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <input type="text" id="recommendPerson" name="recommendPerson" placeholder="추천인" class="w50">
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="form_btn_box">
                        <a href="/apply/eduApply07.do?seq=${seq}" class="btnSt03">초기화</a>
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply07_submit('${seq}');" class="btnSt01">신청하기</a>
                    </div>
