        ...
        <div class="sub_top sub_top_member">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="<%request.getContextPath();%>/static/img/icon_home_mini.png" alt="홈 아이콘"></span><span>로그인</span>
                </div>
                <h2 class="sub_top_title">로그인</h2>
            </div>
        </div>
        <!-- //sub_top -->
