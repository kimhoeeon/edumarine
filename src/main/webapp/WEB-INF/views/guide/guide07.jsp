                ...
                <div class="guide_wrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="box">
                                                    <ul class="list">
                                                        <li>Volvo Penta D6 370마력 (4-Stroke Cycle 디젤엔진)</li>
                                                        <li>Yanmar 700마력 (4-Stroke Cycle 디젤엔진)</li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="box">
                                                    <ul class="list">
                                                        <li>1차 : 2023.03.18(토)~03.19(일)</li>
                                                        <li>2차 : 2023.06.10(토)~06.11(일)</li>
                                                        <li>3차 : 2023.08.05(토)~08.06(일)</li>
                                                        <li>4차 : 2023.10.14(토)~10.15(일)</li>
                                                        <li>5차 : 2023.12.02(토)~12.03(일)</li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="guide_inquiry">
                        ...
                        <div class="guide_btn_box">
                            <div class="btn_box">
                                <a href="javascript:void(0);" onclick="window.location.href='/apply/schedule.do?searchText=EDU07'">교육신청 바로가기</a>
                            </div>
                        </div>
                        <!-- //guide_btn_box -->
                    </div>
