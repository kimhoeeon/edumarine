                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/education/train.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">교육 현황</span>
                                    ...
                                    <form id="dataForm" method="post" onsubmit="return false;">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <input type="text" id="gbn" name="gbn" value="${info.gbn}" class="form-control form-control-solid-bg" placeholder="교육과정명"/>
                                                        <select id="gbn_select" class="form-select form-control-solid-bg ms-4">
                                                            <option selected>직접입력</option>
                                                            <option value="해상엔진 테크니션 (선내기·선외기)" <c:if test="${info.gbn eq '해상엔진 테크니션 (선내기·선외기)'}">selected</c:if> >해상엔진 테크니션 (선내기·선외기)</option>
                                                            <option value="마리나선박 정비사 실기교육" <c:if test="${info.gbn eq '마리나선박 정비사 실기교육'}">selected</c:if> >마리나선박 정비사 실기교육</option>
                                                            <option value="FRP 레저보트 선체 정비 테크니션" <c:if test="${info.gbn eq 'FRP 레저보트 선체 정비 테크니션'}">selected</c:if> >FRP 레저보트 선체 정비 테크니션</option>
                                                            <option value="위탁교육" <c:if test="${info.gbn eq '위탁교육'}">selected</c:if> >위탁교육</option>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input class="form-control form-control-solid onlyNum" id="nextTime" name="nextTime" placeholder="차시" value="${info.nextTime}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
