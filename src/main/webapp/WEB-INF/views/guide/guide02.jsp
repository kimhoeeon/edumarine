    ...
    <div id="container">
        ...
        <div class="sub_top sub_top_guide">
            <div class="inner">
                ...
                <h2 class="sub_top_title">해상엔진 테크니션</h2>
            </div>
        </div>
        <!-- //sub_top -->
                ...
                <div class="guide_wrap">
                    ...
                    <div class="guide_top">
                        <div class="guide_top_tit">
                            <div class="big">해상엔진 테크니션 <span class="small">(선내기 선외기)</span></div>
                            <div class="eng">Marine Engine Technology</div>
                            <div class="text">
                                해양레저 유지보수 분야의 기술인력 수요 증가에 따라, 현장 실무에 적합한 해상 엔진 정비 테크니션 전문인력 양성을 위해<br>
                                교육생을 모집하오니 관심 있는 분들의 많은 지원을 바랍니다.
                            </div>
                        </div>
                        <div class="guide_top_bnr">
                            <div class="bnr_box w700">
                                <div class="bg_box"><img src="<%request.getContextPath();%>/static/img/bg_guide_top_01.jpg"></div>
                                <div class="text_box">
                                    <div class="big">교육 목적</div>
                                    <div class="small">
                                        레저선박 엔진 유지보수 부문 초급 테크니션(전문인력)양성과<br>
                                        해양레저분야 청년취업 지원 등
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="guide_sec">
                        ...
                        <ul class="guide_info_1">
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">15명 내외 <span class="small">※ 교육 신청현황 및 취업수요에 따라 조정 가능</span></div>
                                </div>
                            </li>
                            <li>
                                <div class="gubun">교육비</div>
                                <div class="naeyong">
                                    <div class="text">50만원 (중식, 교통비 등 본인 부담)</div>
                                    <ul class="list small">
                                        <li>교육 수료시 교육비 전액 환급</li>
                                        <li>기존 교육비가 무료라는 점을 악용한 중도 포기자가 증가함에 따라 선량하고 열정적인 지원자에게 공정한 교육 기회를 제공하고자 보증금제도를
                                            도입함</li>
                                    </ul>
                                </div>
                            </li>
                            <li>
                                <div class="gubun">교육장비</div>
                                <div class="naeyong">
                                    <div class="text">선내·외기 신품 엔진(15~370마력) 9종 19대 및 고장 진단장치 등 국내 최상의 교육기자재 구비</div>
                                    <ul class="list small">
                                        <li>(선내기) 볼보펜타/현대씨즈올(전자식), 얀마/두산인프라코어(기계식)</li>
                                        <li>(선외기) 도하츠 15, 18마력, 야마하 40, 75마력, 혼다 60, 225마력</li>
                                        <li>선내·외기 엔진 주요 부속품(터보차져, 연료펌프, 인터쿨러 등) 구비</li>
                                        <li>엔진 브랜드별 특수공구 및 일반·측정공구 완비</li>
                                        <li>스턴드라이브(트랜섬 킷, 프로펠라 포함), 드라이브 어뎁터 등</li>
                                    </ul>
                                </div>
                            </li>
                            <li>
                                <div class="gubun">교육 협력기관</div>
                                <div class="naeyong logo">
                                    <img src="<%request.getContextPath();%>/static/img/logo_guide_01.jpg">
                                    <img src="<%request.getContextPath();%>/static/img/logo_guide_02.jpg">
                                    <img src="<%request.getContextPath();%>/static/img/logo_guide_03.jpg">
                                    <img src="<%request.getContextPath();%>/static/img/logo_guide_04.jpg">
                                    <img src="<%request.getContextPath();%>/static/img/logo_guide_05.jpg">
                                    <img src="<%request.getContextPath();%>/static/img/logo_guide_06.jpg">
                                    <img src="<%request.getContextPath();%>/static/img/logo_guide_07.jpg">
                                    <img src="<%request.getContextPath();%>/static/img/logo_guide_08.jpg">
                                    <img src="<%request.getContextPath();%>/static/img/logo_guide_09.jpg">
                                    <img src="<%request.getContextPath();%>/static/img/logo_guide_10.jpg">
                                </div>
                            </li>
                        </ul>
                        <!-- guide_info_1 -->
                    ...
                    <div class="guide_sec">
                        ...
                        <div class="guide_tit_box">
                            ...
                            <div class="name">지원방법 안내</div>
                        </div>
                        <!-- //guide_tit_box -->
                        <!-- guide_info_2 -->
                        <ul class="guide_info_2">
                            <li>
                                <div class="gubun">지원자격</div>
                                <div class="naeyong">
                                    <div class="text">해양레저분야 취·창업희망자 (졸업예정자 가능)</div>
                                </div>
                            </li>
                            <li>
                        ...
                        <!-- guide_table -->
                        <div class="guide_table">
                            <div class="guide_sub_tit">제출서류</div>
                            <div class="table_box">
                                <table>
                                    <colgroup>
                                        <col width="120px;">
                        ...
                        <!-- //guide_table -->
                        <!-- guide_pros -->
                        <div class="guide_pros">
                            <div class="guide_sub_tit">모집절차</div>
                            <div class="pros_box">
                                <ul class="pros_list">
                                    <li class="box"><div class="text">신청/접수</div></li>
                                    <li class="icon"></li>
                                    <li class="box"><div class="text">서류합격자 발표</div></li>
                                    <li class="icon"></li>
                                    <li class="box"><div class="text">면접심사</div></li>
                                    <li class="icon"></li>
                                    <li class="box"><div class="text">합격자 발표</div></li>
                                </ul>
                                <div class="pros_cmnt">
                                    <p>※ 접수기간 연장 등 사정에 의해 일정 변동 가능</p>
                                    <p>※ 자세한 면접일정 및 장소는 서류합격자 한해 개별통보 예정</p>
                                </div>
                            </div>
                        </div>
                        <!-- //guide_pros -->
                    ...
                    <div class="guide_sec">
                        ...
                        <div class="guide_info_3">
                            ...
                            <ul class="info_cmnt">
                                <li>
                                    <p>
                                        수료기준 : 출석률 90% 이상, 학습 평가점수 60% 이상, 교육과정 중 관련분야에 취업 및 창업시, 출석일수가 총 수업일수의 50% 이상이면<br>
                                        수료자로 인정(단, 경기해양인력양성센터에 사전 통보 必), 무단결석 5회 초과의 경우 수료대상에서 제외</p>
                                    <p>
                                        최종 학습평가결과가 합격등급 60% 미만일 경우, 교육과정 수강으로 처리(수료증 미수여 및 교육비 환불 불가)</p>
                                </li>
                            </ul>
                            <div class="info_text">
                    ...
                    <div class="guide_inquiry">
                        ...
                        <div class="guide_btn_box">
                            <div class="btn_box">
                                <a href="javascript:void(0);" onclick="window.location.href='/apply/schedule.do?searchText=EDU01'">교육신청 바로가기</a>
                            </div>
                        </div>
                        <!-- //guide_btn_box -->
                    </div>
