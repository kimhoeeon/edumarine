    ...
    <div id="container">
        ...
        <div class="sub_top sub_top_guide">
            <div class="inner">
                ...
                <h2 class="sub_top_title">해상엔진 응급조치교육</h2>
            </div>
        </div>
        <!-- //sub_top -->
        ...
        <div id="content_wrap">
            ...
            <div id="sidebar">
                ...
                <ul class="lnb">
                    ...
                    <li class="on"><a href="/guide/guide13.do">해상엔진 응급조치교육</a></li>--%>
                ...
                <div class="guide_wrap">
                    ...
                    <div class="guide_top">
                        <div class="guide_top_tit">
                            <div class="big">해상엔진 응급조치교육</div>
                            <div class="eng">Emergency Response Training for Marine Engines</div>
                            <div class="text">
                                선외기(선내기, 세일요트엔진)를 운항하면서 예기치 않은 고장이 발생하는 경우에 어떤 순서에 의해서<br>
                                고장 발생 원인을 찾고 어떻게 대처해야 되는지를 실습과 관련 이론을 통하여 습득하는 교육과정을 개설합니다.<br>
                        ...
                        <div class="guide_top_bnr">
                            <div class="bnr_box w700">
                                ...
                                <div class="text_box">
                                    ...
                                    <div class="small">
                                        선외기(선내기, 세일요트엔진)에 예기치 않은 엔진 고장이 발생하는 경우에 효과적으로<br>
                    ...
                    <div class="guide_sec">
                        ...
                        <ul class="guide_info_2">
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">${y_applyMethod.value} (<span class="underline"><a href="${y_applyMethodUrl.value}" target="_blank">${y_applyMethodUrl.value}</a></span>)</div>
                                </div>
                            </li>
                            <li>
                                <div class="gubun">모집방법</div>
                                <div class="naeyong">
                                    <div class="text">${y_recruitMethod.value}</div>
                            ...
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="text">${y_recruitPeriod.value}</div>
                    ...
                    <div class="guide_inquiry">
                        ...
                        <div class="guide_btn_box">
                            <div class="btn_box">
                                <a href="javascript:void(0);" onclick="window.location.href='/apply/schedule.do?searchText=EDU15'">교육신청 바로가기</a>
                            </div>
                        </div>
                        <!-- //guide_btn_box -->
                    </div>
