            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                                    ...
                                    <div class="naeyong">
                                        <div style="display: flex; flex-direction: column;">
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="1">선외기·선내기 정비사 실무과정 수료
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="2">엔진에 대한 지식이 있음
                                            </label>
                                            <label style="margin: 5px 0;">
                                                <input type="checkbox" name="trainUnderstand" value="3">전기부분에 대한 기초지식이 있음<%--<br/>--%>
                    ...
                    <div class="form_btn_box">
                        <a href="/apply/eduApply19.do?seq=${seq}" class="btnSt03">초기화</a>
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply19_submit('${seq}');" class="btnSt01">신청하기</a>
                    </div>
