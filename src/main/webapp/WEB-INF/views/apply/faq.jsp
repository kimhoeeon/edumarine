        ...
        <div id="content_wrap">
            ...
            <div id="sidebar">
                ...
                <ul class="lnb">
                    ...
                    <li class="on"><a href="/apply/faq.do">FAQ</a></li>
                </ul>
            </div>
            <!-- //sidebar -->
            ...
            <div id="content" class="sub_board">
                <div class="board_wrap">
                    ...
                    <div class="board_top">
                        ...
                        <div class="board_search">
                            <select id="search_box">
                                <option value="QUESTION" selected>제목</option>
                                <option value="ANSWER">내용</option>
                                <option value="ALL">제목+내용</option>
                            </select>
                            <div class="search_bar">
                                <input type="text" id="search_text" placeholder="검색어 입력">
                                <a href="javascript:void(0);" onclick="faqList(1);" class="search_btn"></a>
                            </div>
                        </div>
                    </div>
                    <!-- //board_top -->
                    ...
                    <!-- board_faq -->
                    <div class="board_faq_wrap">
                        <ul class="board_faq">
                            <%--<li>
                                <div class="ask">행사장 안에서 음식물을 섭취해도 되나요?</div>
                                <div class="answer">
                                    <p><img src="../img/img_sample.jpg" width="500px"></p>
