        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>고마력 선외기 정비 중급 테크니션 (특별반)</span>
                </div>
                <h2 class="sub_top_title">스턴드라이브 정비 전문가과정 (특별반)</h2>
            </div>
        </div>
        <!-- //sub_top -->
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                    ...
                    <div class="form_guide">
                        ...
                        <ul class="list">
                            <li>
                                <div class="gubun">구분</div>
                                <div class="naeyong">스턴드라이브 정비 전문가과정 (특별반)</div>
                            </li>
                            <li>
                                <div class="gubun">교육배경</div>
                                <div class="naeyong">
                                    선내기 실무과정의 연장선으로 실무과정에서 기초로 배운 추진계 중 스턴드라이브에 대해 심화된 내용을 배울 수 있습니다.<br/>
                                    많이 사용되고 있는 스턴드라이브에 대한 맞춤 중급테크니션 양성 과정
                                </div>
                            </li>
                            <li>
                                <div class="gubun">교육내용</div>
                                <div class="naeyong">
                                    추진계 중 레저선박에 많이 사용되고 있는 스턴드라이브의 원리, 구조에 대한 이론과 분해, 조립을 통한 구조 및 정비기술을<br/>
                                    습득할 수 있는 실습으로 구성된 정비기술 습득 과정
                                    <p>이론교육 0.5일</p>
                                    <p>분해 및 시스템분석, 조립, 시운전 3.5일</p>
                                </div>
                            </li>
                            <%--<li>
                                <div class="gubun">교육기간</div>
                                <div class="naeyong">2024.07.29(월) ~ 2024.08.03(토)</div>
                            </li>
                            <li>
                                <div class="gubun">접수기간</div>
                                <div class="naeyong">2024.07.10(수) ~ 2024.07.22(월)</div>
                            </li>
                            <li>
                                <div class="gubun">교육시간</div>
                                <div class="naeyong">6일, 09:30 ~ 17:30 (점심시간 : 12:30 ~ 13:30)</div>
                            </li>
                            <li>
                    ...
                    <div class="form_btn_box">
                        <a href="/apply/eduApply11.do?seq=${seq}" class="btnSt03">초기화</a>
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply11_submit('${seq}');" class="btnSt01">신청하기</a>
                    </div>
