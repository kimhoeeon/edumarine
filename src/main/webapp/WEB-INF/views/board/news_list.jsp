                    ...
                    <div class="board_top">
                        ...
                        <div class="board_search">
                            ...
                            <div class="search_bar">
                                ...
                                <a href="javascript:void(0);" onclick="newsletterList(1);" class="search_btn"></a>
                            </div>
                        </div>
                    </div>
                    <!-- //board_top -->
...
<script src="<%request.getContextPath();%>/static/js/front/newsletter.js?ver=<%=System.currentTimeMillis()%>"></script>
