    ...
    <div id="container">
        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                ...
                <h2 class="sub_top_title">레저선박 해양전자장비 교육</h2>
            </div>
        </div>
        <!-- //sub_top -->
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                        ...
                        <div class="form_box">
                            ...
                            <ul class="form_list">
                                <li>
                                    ...
                                    <div class="naeyong">
                                        <div class="input">
                                            <label><input type="radio" name="choiceDate" value="9/13(토)" <c:if test="${info.choiceDate eq '9/13(토)'}">checked</c:if> >9/13(토)</label>
                                            <label><input type="radio" name="choiceDate" value="10/18(토)" <c:if test="${info.choiceDate eq '10/18(토)'}">checked</c:if> >10/18(토)</label>
                    ...
                    <div class="form_btn_box">
                        ...
                        <input type="hidden" name="chg_trainName" value="레저선박 해양전자장비 교육">
                        ...
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply22_modify_submit(this, '${info.seq}');" class="btnSt01">수정하기</a>
                    </div>
                        ...
                        <div class="popup_inner popup_form">
                            <div class="popup_box popup_form">
                                <div class="box_1">
                                    ...
                                    <div class="text_box">[ 레저선박 해양전자장비 교육 ]을 신청하셨습니다.<br>정말로 취소하시겠습니까?</div>
