...
<c:if test="${status eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/customer/regular.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">상시 사전 신청</span>
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-allow-clear="true" data-hide-search="true" onchange="f_customer_regular_search()">
                                                    <option></option>
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_customer_regular_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th>seq</th>
                                                    <th class="text-center min-w-300px">교육분야</th>
                                                    <th class="text-center min-w-125px">전공</th>
                                                    <th class="text-center min-w-50px">이름</th>
                                                    <th class="text-center min-w-100px">휴대전화 / 이메일</th>
    ...
    <script src="<%request.getContextPath();%>/static/js/mng/regular.js?ver=<%=System.currentTimeMillis()%>"></script>
