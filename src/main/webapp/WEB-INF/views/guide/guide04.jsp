                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="box">
                                                    <div class="number">1) 모터보트 개론</div>
                                                    <div class="number">2) 세일요트 개론</div>
                                                    <div class="number">3) FRP 선체정비 실습</div>
                                                    <div class="number">4) 도장 실습</div>
                                                    <div class="number">5) 현장 견학</div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="box">
                                                    <div class="text">2023. 7. 17(월) ~ 8. 18(금) / 5주, 190시간</div>
                                            ...
                                            <td>
                                                <div class="box">
                                                    <ul class="list">
                                                        <li>
                                                            인하공업전문대학 내 실험 실습실
                                                            <div class="small">인천광역시 남구 인하로 100 인하공업전문대학</div>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="box">
                                                    <div class="text">10명 내외</div>
                                                    <div class="small">※ 교육 신청현황 및 취업수요에 따라 조정 가능</div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="box">
                                                    <div class="text">300,000원 (중식, 교통비 등 본인 부담)</div>
                                                    <div class="small">※ 교육 수료시 교육비 전액 환급되며 미수료 시 환급 불가</div>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div class="box">
                                                    <div class="text" style="text-align: center;">응시원서 및 자기소개서 (사진첨부)</div>
                                                </div>
                                            </td>
                        ...
                        <div class="guide_pros">
                            ...
                            <div class="pros_box">
                                <ul class="pros_list">
                                    ...
                                    <li class="icon"></li>
                                    <li class="box">
                                        <div class="text">서류합격자 발표</div>
                                        <div class="date">23. 7. 3(월)</div>
                                    </li>
                                    <li class="icon"></li>
                                    <li class="box">
                                        <div class="text">면접심사</div>
                                        <div class="date">23. 7. 5(수)</div>
                                    </li>
                                    <li class="icon"></li>
                                    <li class="box">
                                        <div class="text">합격자 발표</div>
                                        <div class="date">23. 7. 7(금)</div>
                                    </li>
                                </ul>
                                <div class="pros_cmnt">
