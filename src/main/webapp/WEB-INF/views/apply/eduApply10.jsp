        ...
        <div class="sub_top sub_top_edu">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="<%request.getContextPath();%>/static/img/icon_home_mini.png" alt="홈 아이콘"></span><span>교육신청</span><span>고마력 선외기 정비 중급 테크니션 (특별반)</span>
                </div>
                <h2 class="sub_top_title">고마력 선외기 정비 중급 테크니션 (특별반)</h2>
            </div>
        </div>
        <!-- //sub_top -->
            ...
            <div id="content" class="sub_apply">
                <div class="join_wrap form_wrap">
                    ...
                    <div class="form_guide">
                        ...
                        <ul class="list">
                            <li>
                                ...
                                <div class="naeyong">고마력 선외기 정비 중급 테크니션 (특별반)</div>
                            </li>
                            <li>
                                <div class="gubun">교육배경</div>
                                <div class="naeyong">
                                    선외기 실무과정의 연장선으로 기존 실무과정에서 한층 심화된 내용을 배울 수 있습니다.<br>
                                    고마력 선외기 사용 증가 추세에 맞춘 중급테크니션 양성 과정
                                </div>
                            </li>
                            <li>
                    ...
                    <div class="form_btn_box">
                        <a href="/apply/eduApply10.do?seq=${seq}" class="btnSt03">초기화</a>
                        <a href="javascript:void(0);" onclick="f_main_apply_eduApply10_submit('${seq}');" class="btnSt01">신청하기</a>
                    </div>
