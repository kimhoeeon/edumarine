        ...
        <div class="sub_top sub_top_member">
            <div class="inner">
                <div class="sub_top_nav">
                    <span class="home"><img src="/img/icon_home_mini.png" alt="홈 아이콘"></span><span>회원가입</span>
                </div>
                    ...
                    <form id="joinForm" method="post" onsubmit="return false;">
                        ...
                        <ul class="form_list">
                            ...
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="input">
                                        <input type="text" id="name" name="name" placeholder="국문 이름 입력" class="w50">
                                        <input type="text" id="nameEn" name="nameEn" placeholder="영문 이름 입력" class="w50" oninput="f_input_box_only_eng(this)">
                                    </div>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <div class="naeyong">
                                    <div class="input">
                                        <label><input type="radio" name="sex" value="남성">남성</label>
